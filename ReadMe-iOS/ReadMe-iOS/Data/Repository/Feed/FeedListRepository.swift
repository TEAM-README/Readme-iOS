...
//    return networkService.getBookListInformation(page: page, category: category)
    return getMockFeedListObservable()
  }
}

extension DefaultFeedListRepository {
  private func getMockFeedListObservable() -> Observable<FeedListEntity?> {
    return .create { observer in
      observer.onNext(self.makeMockFeedList())
      return Disposables.create()
    }
  }
  
  private func makeMockFeedList() -> FeedListEntity {
    let fakeFeedList = [FeedDetailEntity.init(idx: 4, imgURL: "https://bookthumb-phinf.pstatic.net/cover/071/526/07152669.jpg?udate=20220203",
                                              category: "경제/경영",
                                              title: "총균쇠",
                                              author: "재레드 다이아몬드",
                                              sentence: "스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.",
                                              ...
                                              nickname: "혜화동쌍가마",
                                              date: "2020/12/31"),
                        FeedDetailEntity.init(idx: 3, imgURL: "https://bookthumb-phinf.pstatic.net/cover/071/526/07152669.jpg?udate=20220203",
                                              category: "경제/경영",
                                              title: "총균쇠",
                                              author: "재레드 다이아몬드",
                                              ...
                                              nickname: "혜화동쌍가마",
                                              date: "2020/12/31"),
                        FeedDetailEntity.init(idx: 2, imgURL: "https://bookthumb-phinf.pstatic.net/cover/071/526/07152669.jpg?udate=20220203",
                                              category: "경제/경영",
                                              title: "총균쇠",
                                              author: "재레드 다이아몬드",
                                              sentence: "스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.",
                                              ...
                                              nickname: "혜화동쌍가마",
                                              date: "2020/12/31"),
                        FeedDetailEntity.init(idx: 0, imgURL: "https://bookthumb-phinf.pstatic.net/cover/071/526/07152669.jpg?udate=20220203",
                                              category: "경제/경영",
                                              title: "총균쇠",
                                              author: "재레드 다이아몬드",
                                              sentence: "스페인이 잉카를 정복할 수 있었던 원인은 그들이 유전적으로 더 우월해서가 절대 아니다.",
                                              comment: "유럽의 여러 국가는 제국시대에 아프리카와 아메리카 대륙의 많은 나라를 식민지로 만들었다..",
                                              nickname: "혜화동쌍가마",
                                              date: "2020/12/31")]
    
    return FeedListEntity.init(category: [.economy], pageNum: 0, feedList: fakeFeedList)
  }
}
